    ...
    >
      <div className="relative h-64 md:h-80 lg:h-96 w-full overflow-hidden">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center px-4 sm:px-6 text-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 max-w-4xl">
            {title}
          </h1>
          {description && (
            <p className="text-white/90 max-w-2xl mx-auto text-base sm:text-lg md:text-xl">
              {description}
            </p>
          )}
        </div>
