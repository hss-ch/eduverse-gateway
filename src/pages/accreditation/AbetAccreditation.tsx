...
export default function AbetAccreditation() {
  ...
  const handleDemoSuccess = () => {
    ...
    toast({
      ...
      description: "Thank you for your interest in our ABET accreditation solution. Our team will contact you shortly.",
    });
  };
              ...
              <CardContent className="pt-6">
                ...
                <Dialog open={demoDialogOpen} onOpenChange={setDemoDialogOpen}>
                  ...
                  <DialogContent className="sm:max-w-[500px]">
                    <DemoScheduler selectedPlan="ABET Accreditation" onSuccess={handleDemoSuccess} />
                  </DialogContent>
                </Dialog>
              </CardContent>
            </Card>
