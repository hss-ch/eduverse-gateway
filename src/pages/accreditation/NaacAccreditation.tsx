  ...
  return (
    <div className="min-h-screen bg-accent">
      ...
      <PageHeader 
        ...
        description="National Assessment and Accreditation Council - Ensuring Quality in Higher Education"
      />
          ...
          >
            <div className="prose prose-lg max-w-none">
              <h2 className="text-3xl font-bold text-secondary mb-6">
                Why Choose NAAC Accreditation?
              </h2>
              <p className="text-secondary/70 mb-6">
                NAAC accreditation is a mark of quality and excellence in higher education. 
                It helps institutions to know their strengths, weaknesses, and opportunities 
                through an informed review process.
              </p>
              <div className="aspect-video rounded-lg overflow-hidden mb-6">
                <img 
                  src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d"
                  alt="NAAC Accreditation Process"
